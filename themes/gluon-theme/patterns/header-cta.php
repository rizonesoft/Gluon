...
<div class="wp-block-group has-gluon-surface-light-background-color has-background"
    style="border-bottom-color:var(--wp--preset--color--gluon-border);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-group">
            ...
            <button data-gluon-theme-toggle type="button" role="switch" aria-label="Switch to dark mode"
                aria-pressed="false" style="margin-right: 12px;">
            ...
            <div class="wp-block-buttons">
                <!-- wp:button {"backgroundColor":"gluon-accent","textColor":"white","style":{"border":{"radius":"4px"},"spacing":{"padding":{"top":"8px","bottom":"8px","left":"20px","right":"20px"}}}} -->
                <div class="wp-block-button"><a
                        class="wp-block-button__link has-white-color has-gluon-accent-background-color has-text-color has-background wp-element-button"
                        style="border-radius:4px;padding-top:8px;padding-right:20px;padding-bottom:8px;padding-left:20px">Get
                        Started</a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
